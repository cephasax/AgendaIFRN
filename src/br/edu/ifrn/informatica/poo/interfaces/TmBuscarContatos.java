 ...
 * @author Eric Yuzo
 */
public class TmBuscarContatos extends AbstractTableModel {
	/* Lista de Sócios que representam as linhas. */
	private List<Contato> linhas;

	/* Array de Strings com o nome das colunas. */
	private String[] colunas = new String[] { "", "Nome", "Telefone", "Email", "CPF"};

	/* Cria um FuncionarioTableModel vazio. */
	public TmBuscarContatos() {
	 ...
	 * especificada.
	 */
	public TmBuscarContatos(List<Contato> listaContatos) {
	...
	public List<Contato> getLinhas() {
        ...
        public void setLinhas(Contato contato){
            this.linhas = new ArrayList<Contato>();
            this.linhas.add(contato);
        }
